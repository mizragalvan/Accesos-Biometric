...
public class ESMessagesConstants {
	
	public static final String ERROR_CODE = "ERROR";
//	public static final String ERROR_MESSAGE = "Ha ocurrido un error en el servidor";
//	public static final String ERROR_SEND = "Error al enviar el documento a la firma EviSing.";
//	public static final String SUCCES_REPORT = "Documento cargado a la API con éxito.";
//	
//	
...
//	public static final String EMAIL_SECRET_CODE = "Para ingresar necesitará el siguiente código: ";
	...
	public static final String MESSAGE_RETRIEVING_BASE_PATH_ERROR = "Hubo un problema al recuperar la ruta base para guardar los archivos";
